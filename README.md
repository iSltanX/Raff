...
[![الإصدار](https://img.shields.io/badge/%D8%A7%D9%84%D8%A5%D8%B5%D8%AF%D8%A7%D8%B1-v2.1.4-96540F?style=flat-square)](https://github.com/iSltanX/Raff/releases/latest)
...
1. نزّل `Raff_2.1.4_aarch64.dmg` من
...
> اللقطات مأخوذة من واجهة الإصدار v2.1.2 نفسها — الملفات المضمَّنة داخل
> `Raff.app` — وبيانات العناصر فيها عيّنة عرض لا محتوى حقيقي. التخطيط لم
> يتغيّر منذها؛ الفارق الوحيد في v2.1.4 زر «تحديث رَفّ» الصغير في الشريط
> العلوي بجوار شارة «محلي».
...
v2.1.4 إصدار تصحيحي يعالج استقرار العرض: كانت نافذة رَفّ تظهر فارغة أحيانًا
بعد بقائها مخفية طويلًا أو بعد استئناف الجهاز من السكون. صار إظهار النافذة
يفرض إعادة رسم، ومعه مسار تعافٍ تلقائي وزر «تحديث رَفّ» صغير في الشريط
العلوي، وحالة تعافٍ واضحة بدل بقاء الواجهة فارغة. لا تغيير على البيانات
المحفوظة ولا على آلية تسجيل عناصر الحافظة.

قبله جاء v2.1.3 إصدارًا انتقاليًا: قناة التحديث الرسمية انتقلت من مستودع
الإصدارات المنفصل إلى هذا المستودع، فصار المصدر والوثائق والإصدارات وحِزم
التحديث في مكان واحد. مفتاح التوقيع لم يتغيّر، والإصدارات السابقة نُقلت
بملفاتها وتواقيعها كما هي — كل ذلك فوق أساس هوية «رفّ» البصري v2 المعتمد
في v2.0.0.

...
قديم من السجل، ولا تعود العناصر للظهور إلا بعد إنهاء التطبيق وإعادة تشغيله.
السبب مزامنة حالة اللوحة التي كانت تعتمد على حدث إظهار واحد فقط؛ صارت تُعاد
مزامنتها أيضًا عند استعادة تركيز النافذة. ويضيف هذا الإصدار خيار «مسح سجل
الحافظة» في الإعدادات بنافذة تأكيد صريحة، مع الإبقاء على العناصر المثبّتة.

...
[![الإصدار](https://img.shields.io/badge/%D8%A7%D9%84%D8%A5%D8%B5%D8%AF%D8%A7%D8%B1-v2.1.3-96540F?style=flat-square)](https://github.com/iSltanX/Raff/releases/latest)
...
1. نزّل `Raff_2.1.3_aarch64.dmg` من
...
> `Raff.app` — وبيانات العناصر فيها عيّنة عرض لا محتوى حقيقي. الواجهة لم
> تتغيّر في v2.1.3، فاللقطات تمثّله كما هي.
...
v2.1.3 إصدار انتقالي بلا تغييرات وظيفية: قناة التحديث الرسمية انتقلت من
مستودع الإصدارات المنفصل إلى هذا المستودع، فصار المصدر والوثائق والإصدارات
وحِزم التحديث في مكان واحد. مفتاح التوقيع لم يتغيّر، والإصدارات السابقة نُقلت
بملفاتها وتواقيعها كما هي. الواجهة والسلوك وبيانات المستخدم كما في v2.1.2،
الذي أصلح ظهور النافذة فارغة بعد نسخ عنصر قديم وأضاف خيار «مسح سجل الحافظة»،
فوق أساس هوية «رفّ» البصري v2 المعتمد في v2.0.0.

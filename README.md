...
[![الإصدار](https://img.shields.io/badge/%D8%A7%D9%84%D8%A5%D8%B5%D8%AF%D8%A7%D8%B1-v4.2.2-C4704B?style=flat-square)](https://github.com/iSltanX/Raff/releases/latest)
...
1. نزّل `Raff_4.2.2_aarch64.dmg` من
...
v4.2.2 يوحّد أيقونات عناصر سجل الحافظة بحسب نوع المحتوى — نص، رابط، شفرة، أو
صورة — باستخدام أصول Raff Design System المحلية. لم تعد واجهة السجل تنتظر
استخراج أيقونات التطبيقات المصدر من macOS، لذلك تظهر العناصر فورًا بلغة بصرية
متسقة ويقل الضغط غير الضروري على خدمات أيقونات النظام. تبقى معلومة التطبيق
المصدر محفوظة للبحث والسياق، ولا تغيير في صيغة السجل أو الالتقاط أو النسخ
واللصق؛ راجع [CHANGELOG.md](CHANGELOG.md) للتفاصيل الكاملة.

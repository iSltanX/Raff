...
[![الإصدار](https://img.shields.io/badge/%D8%A7%D9%84%D8%A5%D8%B5%D8%AF%D8%A7%D8%B1-v2.1.1-96540F?style=flat-square)](https://github.com/iSltanX/Raff-releases/releases/latest)
...
1. نزّل `Raff_2.1.1_aarch64.dmg` من
...
> اللقطات مأخوذة من واجهة الإصدار v2.1.1 نفسها — الملفات المضمَّنة داخل
...
v2.1.1 إصلاح إضافي: توقيع «برمجة وتصميم سلطان» صار صورة نقطية بدل SVG نصّي،
بعد أن كشف v2.1.0 عطلًا في تجزئة الخط شوَّه اتصال الحروف العربية. فوق أساس
هوية «رفّ» البصري v2 المعتمد في v2.0.0.
